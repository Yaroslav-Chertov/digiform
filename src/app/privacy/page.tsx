...
export const metadata = { title: "Политика конфиденциальности — Digiform" };

const policy = `1. Общие положения
1.1 Настоящая Политика в отношении обработки персональных данных (далее — «Политика») определяет порядок и условия обработки персональных данных ООО "ДиджиФорм" (ИНН: 7709907730, адрес: 127566, г. Москва, Высоковольтный проезд, д. 21, стр. 5 и в отношении пользователей сайта: digiform.ru).
...
1.5 Контакты для обращений субъектов персональных данных: e-mail: work@digiform.ru; почтовый адрес: 127566, г. Москва, Высоковольтный проезд, д. 21, стр. 5. Политика действует с 2026-02-24 и размещается в свободном доступе на сайте.

2. Основные понятия, используемые в Политике
2.1 Автоматизированная обработка персональных данных — обработка персональных данных с помощью средств вычислительной техники.
2.2 Блокирование персональных данных — временное прекращение обработки персональных данных (за исключением случаев, если обработка необходима для уточнения персональных данных).
2.3 Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети Интернет по сетевому адресу digiform.ru.
...
2.8 Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта digiform.ru.
2.9 Персональные данные, разрешенные субъектом персональных данных для распространения, — персональные данные, доступ неограниченного круга лиц к которым предоставлен субъектом персональных данных путем дачи согласия на обработку персональных данных, разрешенных субъектом персональных данных для распространения в порядке, предусмотренном Законом о персональных данных (далее — персональные данные, разрешенные для распространения).
2.10 Пользователь — любой посетитель веб-сайта digiform.ru.
...
5.8 Регистрация и аутентификация пользователей сайта/приложения.
5.9 Обеспечение функционирования и безопасности сайта/приложения.
5.10 Поддержка пользователей и обработка обращений.
5.11 Проведение мероприятий, вебинаров и рассылок.
...
6.8 Для цели «Регистрация и аутентификация пользователей сайта/приложения» правовыми основаниями являются: договор (оферта/пользовательское соглашение); 126-ФЗ «О связи» (уведомления); согласие (при необходимости).
6.9 Для цели «Обеспечение функционирования и безопасности сайта/приложения» правовыми основаниями являются: законный интерес оператора (обеспечение работоспособности и безопасности); 149-ФЗ; локальные НПА; согласие (на cookie/аналитику при необходимости).
6.10 Для цели «Поддержка пользователей и обработка обращений» правовыми основаниями являются: договор/оферта; 126-ФЗ (запись разговоров при информировании); согласие (если требуется).
6.11 Для цели «Проведение мероприятий, вебинаров и рассылок» правовыми основаниями являются: договор (оферта на участие); согласие на рассылку/рекламу; 38-ФЗ «О рекламе»; 126-ФЗ «О связи».
6.12 Также правовыми основаниями могут являться уставные документы оператора, локальные нормативные акты, а также заключённые с субъектами договоры и/или выданные ими согласия (в случаях, предусмотренных законодательством).
...
7.8 По цели «Регистрация и аутентификация пользователей сайта/приложения» могут обрабатываться следующие категории данных: ФИО, логин, e-mail, телефон, идентификаторы аккаунта, пароли/хэши, коды 2FA, IP-адреса, cookie/токены сессий.
7.9 По цели «Обеспечение функционирования и безопасности сайта/приложения» могут обрабатываться следующие категории данных: IP-адреса, дата/время, URL, заголовки и технические идентификаторы, cookie/SDK, данные об устройстве, логи ошибок и доступа.
7.10 По цели «Поддержка пользователей и обработка обращений» могут обрабатываться следующие категории данных: ФИО, контакты, содержимое обращений/звонков/чатов, записи звонков, метаданные тикетов, платёжные/заказные данные при необходимости.
7.11 По цели «Проведение мероприятий, вебинаров и рассылок» могут обрабатываться следующие категории данных: ФИО, контакты, должность/организация (если указано), регистрационные анкеты, посещаемость, предпочтения, результаты опросов.
7.12 Субъектами персональных данных могут являться, в зависимости от целей, посетители сайта/пользователи сервисов, клиенты, контрагенты (физические лица), представители контрагентов (юридических лиц), работники, кандидаты на вакантные должности и иные лица.
...
8.3 Пользователь вправе в любой момент отозвать согласие на обработку персональных данных направив обращение на work@digiform.ru. После отзыва Оператор прекращает обработку, за исключением случаев, когда обработка допускается без согласия субъекта в силу закона или иных правовых оснований.
...
8.11 Для цели «Регистрация и аутентификация пользователей сайта/приложения» совершаются следующие действия (операции) с персональными данными: сбор, запись, систематизация, накопление, хранение, уточнение (обновление, изменение), извлечение, использование, передача (предоставление, доступ), обезличивание, блокирование, удаление, уничтожение.
8.12 Для цели «Обеспечение функционирования и безопасности сайта/приложения» совершаются следующие действия (операции) с персональными данными: сбор, запись, систематизация, накопление, хранение, уточнение (обновление, изменение), извлечение, использование, передача (предоставление, доступ), обезличивание, блокирование, удаление, уничтожение.
8.13 Для цели «Поддержка пользователей и обработка обращений» совершаются следующие действия (операции) с персональными данными: сбор, запись, систематизация, накопление, хранение, уточнение (обновление, изменение), извлечение, использование, передача (предоставление, доступ), обезличивание, блокирование, удаление, уничтожение.
8.14 Для цели «Проведение мероприятий, вебинаров и рассылок» совершаются следующие действия (операции) с персональными данными: сбор, запись, систематизация, накопление, хранение, уточнение (обновление, изменение), извлечение, использование, передача (предоставление, доступ), обезличивание, блокирование, удаление, уничтожение.
8.15 Обработка может осуществляться с использованием средств автоматизации и/или без их использования.
8.16 При хранении персональных данных оператор использует базы данных, находящиеся на территории Российской Федерации (ч. 5 ст. 18 Закона о персональных данных).
8.17 Сроки хранения: не дольше, чем этого требуют заявленные цели обработки, если иной срок не установлен законом или договором.
8.18 На сайте могут использоваться файлы cookie для обеспечения корректной работы сервисов и улучшения пользовательского опыта.
8.19 Может вестись аналитика посещений (в т.ч. с применением счётчиков/пикселей/SDK), при этом обрабатываются минимально необходимые данные. Использование маркетинговых идентификаторов требует согласия, если это предусмотрено законом.
8.20 Оператор вправе передавать персональные данные уполномоченным органам по основаниям, предусмотренным законодательством Российской Федерации.
...
11.2 Актуальная редакция Политики всегда доступна на сайте Оператора digiform.ru.
